            ...
            <section className="py-24 px-6 border-b border-[#EFEFEF] bg-[#F8F8F8]">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="rounded-2xl overflow-hidden border border-[#EFEFEF] aspect-video relative">
                        <img src={vInsuranceImg} loading="lazy" className="w-full h-full object-cover" alt="Doorstep Insurance Inspection" />
            ...
            <section className="py-24 px-6 bg-[#F8F8F8] border-y border-[#EFEFEF]">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16 relative">
                        {[
                            { step: "01", title: "Select Coverage", desc: "Choose the protection level for your vehicle.", img: stepSelectImg },
                            { step: "02", title: "Digital Verify", desc: "Instantly upload details on our platform.", img: stepBookImg },
                            { step: "03", title: "Protected", desc: "Zero hassle. Complete safety for the road ahead.", img: stepResultsImg }
                        ].map((item, i) => (
